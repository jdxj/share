...
func (c *userService) SignUp(ctx context.Context, in *RequestLogin, opts ...client.CallOption) (*ResponseLogin, error) {
...
func RegisterUserHandler(s server.Server, hdlr UserHandler, opts ...server.HandlerOption) error {
	type user interface {
		...
		SignUp(ctx context.Context, in *RequestLogin, out *ResponseLogin) error
	}
	type User struct {
		user
	}
...
func (h *userHandler) SignUp(ctx context.Context, in *RequestLogin, out *ResponseLogin) error {
